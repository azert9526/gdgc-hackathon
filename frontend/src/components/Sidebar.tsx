...
const Sidebar = () => {
  ...
  return (
    <aside className="flex w-64 flex-col bg-white dark:bg-background-dark h-full">
      ...
      <nav className="flex-1 space-y-1 px-3 py-6 border-l border-slate-200 dark:border-slate-800">
