  ...
  return (
    <aside className="flex w-64 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark h-full">
      <div className="flex items-center gap-3 px-6 py-6 border-b border-slate-200 dark:border-slate-800">
        ...
        <h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">CloudPlatform</h2>
      </div>
      <nav className="flex-1 space-y-1 px-3 py-6">
        ...
        <Link to="/dashboard" className="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-primary transition-colors">
